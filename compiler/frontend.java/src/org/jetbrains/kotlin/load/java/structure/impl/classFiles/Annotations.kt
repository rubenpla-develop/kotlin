...
internal class AnnotationsCollectorMethodVisitor(
    ...
    override fun visitAnnotation(desc: String, visible: Boolean) =
            BinaryJavaAnnotation.addAnnotation(
                    ...
                    desc, context, signatureParsingComponent
            )
    ...
    override fun visitParameterAnnotation(parameter: Int, desc: String, visible: Boolean): AnnotationVisitor? {
        ...
        val annotations =
                member.safeAs<BinaryJavaMethodBase>()?.valueParameters?.get(index)?.annotations as MutableCollection<JavaAnnotation>?
                ?: return null

        return BinaryJavaAnnotation.addAnnotation(annotations, desc, context, signatureParsingComponent)
    }
}
...
class BinaryJavaAnnotation private constructor(
    ...
    companion object {
        ...
        fun createAnnotationAndVisitor(
            ...
            return annotation to BinaryJavaAnnotationVisitor(context, signatureParsingComponent, arguments)
        }
        ...
        fun addAnnotation(
            ...
            val (javaAnnotation, annotationVisitor) = createAnnotationAndVisitor(desc, context, signatureParsingComponent)
...
class BinaryJavaAnnotationVisitor(
    ...
    override fun visitAnnotation(name: String?, desc: String): AnnotationVisitor {
        val (annotation, visitor) =
                BinaryJavaAnnotation.createAnnotationAndVisitor(desc, context, signatureParsingComponent)
    ...
    private fun convertConstValue(name: String?, value: Any?): JavaAnnotationArgument? {
        return when (value) {
            ...
            is Type -> PlainJavaClassObjectAnnotationArgument(name, value, signatureParsingComponent, context)
    ...
    override fun visitArray(name: String?): AnnotationVisitor {
        ...
        return BinaryJavaAnnotationVisitor(context, signatureParsingComponent, result)
    }
}
...
class PlainJavaClassObjectAnnotationArgument(
    ...
    override fun getReferencedType() = signatureParsingComponent.mapAsmType(type, context)
}
