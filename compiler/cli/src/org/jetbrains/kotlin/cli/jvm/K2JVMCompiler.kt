...
class K2JVMCompiler : CLICompiler<K2JVMCompilerArguments>() {
    ...
    companion object {
        ...
        private fun putAdvancedOptions(configuration: CompilerConfiguration, arguments: K2JVMCompilerArguments) {
            ...
            configuration.put(JVMConfigurationKeys.USE_FAST_CLASS_FILES_READING, arguments.useFastClassFilesReading)

            if (arguments.useFastClassFilesReading) {
                configuration.getNotNull(CLIConfigurationKeys.MESSAGE_COLLECTOR_KEY)
                             .report(INFO, "Using fast java class files reading implementation")
            }
